...
class BaselineNLPFlow(FlowSpec):
    ...
    def baseline(self):
        ...
        predicted = self.valdf.apply(predict,axis=1)
        ...
        self.base_acc = accuracy_score(self.valdf.label,predicted)
        self.base_rocauc = roc_auc_score(self.valdf.label,predicted)
